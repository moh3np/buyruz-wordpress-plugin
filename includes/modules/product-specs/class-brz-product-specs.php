        ...
        <script>
            jQuery(document).ready(function($) {
                ...
                $('#brz-layout-copy-btn').on('click', function() {
                    ...
                    text += "۱. خروجی شما باید منحصراً شامل کادر کد کپی‌شونده (Code block با سه علامت بک‌تیک ```) باشد.\n";
                    text += "۲. در داخل کادر کد، فقط شناسه‌ها (مانند manual_min_age یا pa_brand) را به ترتیب اولویت نمایش (از بالا به پایین)، هر کدام در یک خط قرار دهید.\n";
                    text += "۳. هیچ متن اضافی، توضیح، سلام/خداحافظی یا شماره‌گذاری در داخل یا خارج کادر کد قرار ندهید. خروجی باید کاملاً آماده کپی و پیست مستقیم در سایت باشد.\n\n";
