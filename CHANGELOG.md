...
### ویژگی جدید
- **پشتیبانی از تگ مخفی در باکس ارسال رایگان:** اکنون می‌توانید از تگ `<span class="sr-only">` در متن باکس ارسال رایگان قالب باکالا استفاده کنید. این تگ برای سئو و جئو مفید است و بدون نمایش به کاربر، در کد صفحه حضور خواهد داشت.
...
### توضیحات
- این ماژول به‌صورت پیش‌فرض غیرفعال است. برای استفاده ابتدا از پیشخوان تنظیمات بایروز آن را روشن کنید.
